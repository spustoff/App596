                    ...
                    VStack(spacing: 15) {
                        ...
                        ZStack(alignment: .leading, content: {
                            ...
                            Text("Place")
                                .foregroundColor(.black.opacity(0.3))
                                .font(.system(size: 14, weight: .regular))
                                .opacity(viewModel.hisPlace.isEmpty ? 1 : 0)
                            
                            TextField("", text: $viewModel.hisPlace)
                                .foregroundColor(Color.black)
                                .font(.system(size: 14, weight: .semibold))
                        ...
                        ZStack(alignment: .leading, content: {
                            ...
                            Text("Occupied place")
                                .foregroundColor(.black.opacity(0.3))
                                .font(.system(size: 14, weight: .regular))
                                .opacity(viewModel.hisOPlace.isEmpty ? 1 : 0)
                            
                            TextField("", text: $viewModel.hisOPlace)
                                .foregroundColor(Color.black)
                                .font(.system(size: 14, weight: .semibold))
...
#Preview {
    AddHistory(viewModel: ResultsViewModel())
}
